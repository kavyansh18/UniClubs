  ...
  return (
    ...
    <Lamp>
      ...
      >
        ...
        <p className="py-1 bg-gradient-to-r from-stone-500 to-stone-700 bg-clip-text text-transparent text-center text-6xl font-medium tracking-tight  md:text-6xl lg:relative absolute lg:bottom-0 bottom-[15rem] lg:left-0 left-[1.5rem]">
          UniClubs
        </p>
