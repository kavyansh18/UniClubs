  ...
  return (
    ...
    >
      ...
      <div className="relative z-50 flex -translate-y-80 flex-col items-center px-5">
        ...
        <NavLink to="/clubs">
          <motion.div
            ...
            className="w-full absolute top-[15rem] right-0 flex justify-center items-center"
          >
      ...
      <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.3, duration: 0.8, ease: "easeInOut" }}
            className="w-full z-50 absolute bottom-12 right-0 flex justify-center items-center"
          >
